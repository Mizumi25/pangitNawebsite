...
export declare class GlobStream<O extends GlobWalkerOpts = GlobWalkerOpts> extends GlobUtil<O> {
    ...
    constructor(patterns: Pattern[], path: Path, optOq].´˛|Ó≤1@˝¿ŒµÇ˘ÀÅÉg≥Îb‹=∆X∏î‘dπŒÚvìo≤ˇ3µdæ∏˘Œœ'”Î¡~≠D?‰mØ4l◊R@ëWáGŸjUCµ®X≥≤Éz“=ØJ¸e≠SOR'z&&∏øÿ’IP•jÎ—ÂD®ÒïÙ?`u–˘»Ìòà1ÁWesBËM±·•G2’≥´9t€Ê∑